function [q,h] = heattransfer_flatplate_pipe(f_t,L_plate,width_chamber,V_chamber,D_chamber,D_bottle,L_bottle,T_cw,C_to_K,T_bottle)
A_chamber_flow = width_chamber*(D_chamber-D_bottle)/2;
[Pr,k,rho,mu,~,~] = thermalprop(T_cw+C_to_K);

syms Re D_h Reinf
eq1 = Re == rho*V_chamber*D_h/mu;
